            ...
            {loading ? (
                ...
                <div>
                    <table border={0} style={{ width: "auto" }}>
                        <tr style={{ whiteSpace: "nowrap" }}>
                            ...
                            <td>
                                <img
                                    ...
                                    src={require(`../static/${
                                        information.type.replace("·", "") === "--" ? "属性" : information.type.replace("·", "")
                                    }.webp`)}
                                />
                        ...
                        <tr>
                            <th>技能持有者</th>
                            <td style={{ whiteSpace: "pre-line" }}>{information.petsName}</td>
                        </tr>
                        <tr>
                            <th>技能效果</th>
                            <td style={{ whiteSpace: "pre-line" }}>{information.des}</td>
                        </tr>
                    </table>
                </div>
            )}
